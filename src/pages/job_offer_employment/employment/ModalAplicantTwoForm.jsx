...
export default class ModalAplicantTwoForm extends PureComponent {
  render() {
    const menuOne = (
      <div
        ...
        <div className="flex flex-col flex-1">
          <div>
            <Input
              ...
              type="text"
              className="w-64 font-bold font-all"
              size="large"
            />
          </div>
          <div className="flex flex-row items-center text-xs py-2">
            <div className="flex text-orange-500">
              ...
              <span className="text-orange-500">متقاضی جدید</span>
            </div>
        ...
        <div className="flex flex-col justify-end items-end">
          ...
          <div>
            <Dropdown overlay={menuOne} placement="bottomCenter" arrow>
              <Button className="text-white text-sm bg-green-500 font-all ">تایید برای مصاحبه</Button>
            </Dropdown>
            <RejectTheApplicant />
          </div>
        </div>

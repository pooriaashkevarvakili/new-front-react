...
import { Avatar, Card, Checkbox, Modal } from 'antd';
...
*/
            ...
            <div className="container">
              ...
              <div>
                <div>
                  ...
                  {/*<span className="absolute mr-12 text-sm font-extrabold">*/}
                  {/*  <Checkbox className="text-xs font-all">{model.description}</Checkbox>*/}
                  {/*</span>*/}
                </div>
  ...
  componentDidMount() {
    Axios.get('http://localhost:3005/api/interview').then((res) => {
      const data = res.data;

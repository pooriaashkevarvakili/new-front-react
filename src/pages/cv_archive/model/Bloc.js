...
import { save, init, get, remove, update, getDropDownForCvArchive } from './../service';
...
export default class ResumeArchiveBloc {
  ...
  init = async () => {
    ...
    const { sex, skills, educations, send_locations, job_titles } = data;
    this.repo.sex = sex;
  ...
  fetch() {}
  getDropDownForCvArchive = async () => {
    const data = await getDropDownForCvArchive();
    const { job_titles, send_locations, skills, sex, educations } = data;

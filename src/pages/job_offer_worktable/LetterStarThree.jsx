...
export default class LetterStarThree extends PureComponent {
  render() {
    return (
      /*
میزکار پیام های منتخب کارد چهارم
*/
            ...
            <div>
              <div className="flex flex-row">
                <img
                  ...
                  alt="shakiba"
                />
                <span className="mr-16  font-all  text-xs">ناهید زادفتح الله</span>
